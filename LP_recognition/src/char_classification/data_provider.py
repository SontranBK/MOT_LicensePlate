...
import numpy as np
import sys  
sys.path.append('D:/Workspace/SELF/numberplaterecognition/src')  
import data_utils
class Datasets(object):
    def __init__(self):
        ...
        # Input data
        self.digits_data = data_utils.get_digits_data('src/char_classification/data/digits.npy')
        self.alphas_data = data_utils.get_alphas_data('src/char_classification/data/digits.npy')
